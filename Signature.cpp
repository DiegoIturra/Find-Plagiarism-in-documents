...
/********************* Metodos de testeo **********************/
void Signature::showSignatureMatrix(){
...
bool Signature::existShingle(const string& shingle){
...
void Signature::mapFilenamesToIds(const vector<KShingleStructure>& listOfKShinglesStructures){
...
void Signature::createMapOfShingles(const vector<KShingleStructure>& listOfKShinglesStructures){
	unsigned uniqueId = 0;
	for(KShingleStructure kshingleStructure : listOfKShinglesStructures){
...
Signature::Signature(vector<KShingleStructure>& listOfKShinglesStructures){
...
vector<HashValues> Signature::createHashValues(){
...
unsigned Signature::hashFunction(unsigned idShingle , HashValues& hashValues){
	return (hashValues.a * idShingle + hashValues.b) % hashValues.p;
}



void Signature::applyMinHash(){
