...
class Signature{
	private:
		const unsigned numberOfHashFunctions = 100; //TODO: dejar en 100 o mas
		...
		//Metodo auxiliar para visualizar matriz de signatures
	...
	public:
		Signature(vector<KShingleStructure>& listOfKShinglesStructures);
